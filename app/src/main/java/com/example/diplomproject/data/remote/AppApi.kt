...
interface AppApi {
    ...
    suspend fun getControllerCategories(@Header("Authorization") auth: String): List<TestCategoryDto>
    ...
    suspend fun getControllerTokens(@Header("Authorization") auth: String): List<ControllerTokenResponseDto>
