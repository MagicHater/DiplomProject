...
VALUES
    ('30000000-0000-0000-0000-000000000001', 'Как вы ведете себя, если одновременно поступают несколько срочных задач?', '{"attention": 0.35, "stress_resistance": 0.20, "responsibility": 0.20, "adaptability": 0.15, "decision_speed_accuracy": 0.10}', 2, 10, TRUE),
    ...
    ('30000000-0000-0000-0000-000000000003', 'Насколько легко вы сохраняете концентрацию при монотонной работе?', '{"attention": 0.55, "stress_resistance": 0.10, "responsibility": 0.20, "adaptability": 0.05, "decision_speed_accuracy": 0.10}', 1, 8, TRUE),
    ...
    ('30000000-0000-0000-0000-000000000006', 'Как вы реагируете на высокий уровень стресса в течение смены?', '{"attention": 0.10, "stress_resistance": 0.55, "responsibility": 0.15, "adaptability": 0.10, "decision_speed_accuracy": 0.10}', 2, 9, TRUE),
    ...
    ('30000000-0000-0000-0000-000000000010', 'Как вы поддерживаете рабочую продуктивность к концу длительной смены?', '{"attention": 0.20, "stress_resistance": 0.30, "responsibility": 0.20, "adaptability": 0.20, "decision_speed_accuracy": 0.10}', 2, 6, TRUE);

INSERT INTO question_options (id, question_id, option_order, option_text, contribution_value)
SELECT
    ('40000000-0000-0000-0000-' || LPAD((row_number() OVER ())::text, 12, '0'))::UUID,
    q.id,
    o.option_order,
    o.option_text,
...
CROSS JOIN (
    VALUES
        (1::SMALLINT, 'Полностью не согласен', -2.00::NUMERIC(6,2)),
        (2::SMALLINT, 'Скорее не согласен', -1.00::NUMERIC(6,2)),
        (3::SMALLINT, 'Нейтрально', 0.00::NUMERIC(6,2)),
        (4::SMALLINT, 'Скорее согласен', 1.00::NUMERIC(6,2)),
        (5::SMALLINT, 'Полностью согласен', 2.00::NUMERIC(6,2))
) AS o(option_order, option_text, contribution_value)
